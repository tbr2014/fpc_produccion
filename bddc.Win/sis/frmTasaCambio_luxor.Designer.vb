...
Partial Class frmTasaCambio_luxor
    ...
    Friend WithEvents Luxor_tblaux_tipocambioTableAdapter As bddc.Win.BDClientesDataSetTableAdapters.Luxor_tblaux_tipocambioTableAdapter
