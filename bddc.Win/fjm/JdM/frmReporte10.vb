...
#End Region
    ...
    Private Sub frmReporte9_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'BdClientesDataSet1.Luxor_tbllim_grupoclientebaccarat' table. You can move, or remove it, as needed.
        Me.Luxor_tbllim_grupoclientebaccaratTableAdapter.Fill(Me.BdClientesDataSet1.Luxor_tbllim_grupoclientebaccarat)   
