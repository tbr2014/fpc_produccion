...
Public Class crCalendarioPuntaje
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crCalendarioPuntaje.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bddc.Win.crCalendarioPuntaje.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_parTipoJuego() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrCalendarioPuntaje
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCalendarioPuntaje = New crCalendarioPuntaje()
        rpt.Site = Me.Site
        Return rpt
    End Function
