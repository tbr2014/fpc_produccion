...
Public Class crRatingTotal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bddc.Win.crRatingTotal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRatingTotal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRatingTotal = New crRatingTotal()
        rpt.Site = Me.Site
        Return rpt
    End Function
