...
Public Class crRatingDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "bddc.Win.crRatingDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRatingDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRatingDetalle = New crRatingDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
